...
das_40_questions = [
    ...
    "자신에게 중요한 사람들에게 인정받지 못하는 것은 끔찍한 일이다.",
...
if st.session_state.app_step == 0:
    ...
    with tab3:
        if "farewell_letter" not in st.session_state:
            letters = [
                f"""
                <div class="letter-title">상담사 AI의 편지<br>'완벽하지 않아도 충분한 당신에게'</div>
                ...
                """,
                f"""
                <div class="letter-title">상담사 AI의 편지<br>'타인의 시선에서 나의 내면으로'</div>
                ...
                """,
                f"""
                <div class="letter-title">상담사 AI의 편지<br>'실험하는 삶의 즐거움'</div>
                ...
                """,
                f"""
                <div class="letter-title">상담사 AI의 편지<br>'조건 없는 자기 수용을 향해'</div>
                {st.session_state.user_name} 님, 대망의 마지막 날입니다. 그동안 바쁜 일상 속에서도 잊지 않고 찾아와 주셔서, 그리고 꾸미지 않은 솔직한 마음을 들려주셔서 진심으로 고맙습니다.<br><br>
                우리가 집중했던 인지행동치료(CBT)의 핵심은 결국 '내가 나를 어떻게 바라볼 것인가'에 대한 질문이었습니다. 무언가를 뛰어나게 성취하거나 남들에게 인정받아야만 가치 있는 사람이 된다는 조건부 신념의 연결고리를 끊어내는 작업은 꽤 고통스러웠을지도 모릅니다. 하지만 끝내 하향 화살표의 끝에서, 조건 없이 나를 사랑할 수 있는 단단한 바닥을 발견하셨습니다.<br><br>
                ...
                """,
                f"""
                <div class="letter-title">상담사 AI의 편지<br>'회색 지대의 아름다움'</div>
                ...
                성공 아니면 실패, 선 아니면 악으로 세상을 나누던 '이분법적 사고'에서 벗어나, 이제는 1부터 100 사이의 수많은 스펙트럼(연속선)을 볼 수 있는 눈을 가지게 되셨습니다. 세상은 흑백으로만 칠해져 있지 않으며, 가끔은 흐릿하고 모호한 회색 지대 안에 오히려 편안함과 진실이 숨어 있다는 것을 우리는 함께 배웠습니다.<br><br>
